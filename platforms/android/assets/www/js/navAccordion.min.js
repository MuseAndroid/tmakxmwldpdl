	...
	$.fn.navAccordion = function(options, callback){
		this.each(function(){
			...
			var settings = $.extend({
				...
				headersOnly: true,  //False is default - setting to true will make any link with sub-nav behave as if it were set to header only, making the link inaccessible - this option is useful if you are using the plugin for a non-navigation area
				headersOnlyCheck: true, // False is default - set to true to apply the accordion only to links that are set as "header only" (have no href)
